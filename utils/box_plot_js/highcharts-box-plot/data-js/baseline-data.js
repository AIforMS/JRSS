...
Highcharts.chart('container', {
	...
	xAxis: {  // x 轴属性
		...
		lineColor: 'black',
		categories: ['Liver', 'Letf-kidney', 'Right-kidney', 'Stomach', 'Pancreas', 'Gallbladder', 'Esophagus', 'Duodenum'],
		// title: {
		// 	text: 'Experiment No.'
		// },
		height: '60%',  // x 轴线上下位置
		...
		*/ 
		{
			...
			data: [
				 ...
				 * 
				*/
				[0.76, 0.82, 0.86, 0.91, 0.95],  // Liver
				[0.73, 0.79, 0.85, 0.90, 0.95],  // Letf-kidney
				[0.72, 0.78, 0.84, 0.88, 0.921],  // Right-kidney
				[0.40, 0.51, 0.63, 0.73, 0.835],  // Stomach
				[0.45, 0.555, 0.615, 0.675, 0.71],  // Pancreas
				[0.42, 0.50, 0.57, 0.64, 0.68],  // Gallbladder
				[0.40, 0.46, 0.525, 0.56, 0.59],  // Esophagus
				[0.29, 0.38, 0.44, 0.52, 0.55],  // Duodenum
			]
		}, {
